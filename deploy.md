...
当前版本新建队伍强制填写队长 QQ，旧版小程序不带此字段会返回中文 422。通常先将包含 QQ 输入框的新版小程序上传审核，待可发布时安排前后端配套更新；发布后旧版本用户需重新进入最新版。2026-09-12 经维护者明确分工，后端与数据库已部署为 `captain-qq-20260912-144117`，前端由维护者自行发布，代理未上传或发布小程序。
